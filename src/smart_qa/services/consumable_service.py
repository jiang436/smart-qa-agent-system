...
CATALOG = {
    "清洁刷组": {
        ...
        "main_brush": {
            ...
            "life_days": 180,
            "category": "清洁刷组",
            "desc": "地毯家庭磨损快，4-8个月更换",
        },
    },
    "拖地配套": {
        "mop": {
            "name": "X30 Pro 水洗拖布(3片)",
            "model": "X30-MP-01",
            "price": 25.0,
            "life_days": 60,
            "category": "拖地配套",
    ...
    "套装优惠": {
        ...
        "deep_kit": {
            "name": "深度清洁套装(边刷x2+滚刷+滤网x2+拖布+清洁液)",
            "model": "X30-KIT-D",
            "price": 199.0,
            "life_days": 0,
            "category": "套装优惠",
