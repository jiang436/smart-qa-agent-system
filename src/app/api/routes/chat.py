...
from src.app.api.deps import check_rate_limit, check_security
from src.app.api.stream_handler import SSEStreamHandler
from src.app.deps import get_agent_graph, get_security
from src.models.chat_schema import ChatRequest, ChatResponse
from src.observability.logger import logger
from src.observability.tracer import get_tracer
from src.security import SensitiveFilter
...
async def chat(
    ...
    if not request.message.strip():
        from src.agent.persona import WELCOME_MESSAGE
        return ChatResponse(
...
async def chat_stream(
    ...
    return StreamingResponse(
        SSEStreamHandler.stream_agent_response(
            agent_executor=graph, query=request.message, user_id=request.user_id, initial_state=state,
        ),
